...
import pandas as pd
from add_footer import add_footer  # import dello script per aggiungere il footer alle immagini
...
add_footer(parsed_args.input_file.replace(".txt", "__mappa.svg"))  # chiamata a fine script per aggiungere il footer
plt.show()
